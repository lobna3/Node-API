...
function AddProduct() {
  return (
    <div class="py-5 md:py-0 bg-black/[0.15] dark:bg-transparent">
      <div class="flex mt-[4.7rem] md:mt-0 overflow-hidden">
        ...
        <div class="content">
              ...
              <div class="dropdown-menu w-56">
                <ul class="dropdown-content bg-primary text-white">
                  ...
                  <li>
                    <a href="" class="dropdown-item hover:bg-white/5">
                      {" "}
                      <i data-lucide="edit" class="w-4 h-4 mr-2"></i> Add
                      Account{" "}
                    </a>
                  </li>
                  <li>
          ...
          <div class="grid grid-cols-11 gap-x-6 mt-5 pb-20">
            <div
              class="intro-y col-span-11 alert alert-primary alert-dismissible show flex items-center mb-6"
              role="alert"
            >
              <span>
                    ...
                    <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                      ...
                      <div class="w-full mt-3 xl:mt-0 flex-1">
                        <select id="category" class="form-select">
                          <option value="Smartphone &amp; Tablet">
                            Smartphone &amp; Tablet
                          </option>
                    ...
                    <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                      ...
                      <div class="w-full mt-3 xl:mt-0 flex-1">
                        <select
                          ...
                          multiple
                        >
                          <option selected value="Smartphone &amp; Tablet">
                            Smartphone &amp; Tablet
                          </option>
                        ...
                        <div class="text-left">
                          ...
                          <div class="leading-relaxed text-slate-500 text-xs mt-3">
                            <div>
                              ...
                              detailed explanation of your product so that it is
                              easy to understand and find your product.
                            </div>
                            <div class="mt-2">
                        ...
                        <div class="relative pl-5 pr-5 xl:pr-10 py-10 bg-slate-50 dark:bg-transparent dark:border rounded-md">
                          ...
                          <div>
                            ...
                            <div class="form-inline mt-5 items-start first:mt-0">
                              <label class="form-label mt-2 sm:w-20">
                                Options
                              </label>
                              <div class="flex-1">
                          ...
                          <table class="table border">
                            <thead>
                              <tr>
                                ...
                                <th class="bg-slate-50 dark:bg-darkmode-800 text-slate-500 whitespace-nowrap !pl-2">
                                  Variant Code
                                </th>
                              </tr>
                            </thead>
                    ...
                    <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                      <div class="form-label xl:w-64 xl:!mr-10">
                        <div class="text-left">
                          ...
                          <div class="leading-relaxed text-slate-500 text-xs mt-3">
                            {" "}
                            If the status is active, your product can be
                            searched for by potential buyers.{" "}
                          </div>
                        </div>
                      </div>
                      <div class="w-full mt-3 xl:mt-0 flex-1">
                    ...
                    <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                      <div class="form-label xl:w-64 xl:!mr-10">
                        <div class="text-left">
                          ...
                          <div class="leading-relaxed text-slate-500 text-xs mt-3">
                            {" "}
                            Use a unique SKU code if you want to mark your
                            product.{" "}
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="mt-5">
                    <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                      ...
                      <div class="w-full mt-3 xl:mt-0 flex-1">
                        ...
                        <div
                          class="alert alert-outline-warning alert-dismissible show flex items-center bg-warning/20 dark:bg-darkmode-400 dark:border-darkmode-400 mt-5"
                          role="alert"
                        >
                          <span>
                            <i
                    ...
                    <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                      <div class="form-label xl:w-64 xl:!mr-10">
                        <div class="text-left">
                          ...
                          <div class="leading-relaxed text-slate-500 text-xs mt-3">
                            {" "}
                            Enter the product size after packing to calculate
                            the volume weight.{" "}
                            <a class="text-primary font-medium" href="">
                              Learn Volume Weight
                            </a>{" "}
                    ...
                    <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                      <div class="form-label xl:w-64 xl:!mr-10">
                        <div class="text-left">
                          ...
                          <div class="leading-relaxed text-slate-500 text-xs mt-3">
                            {" "}
                            Configure shipping services according to your
                            product type.{" "}
                          </div>
                        </div>
                      </div>
      ...
      <div
        data-url="side-menu-dark-dashboard-overview-3.html"
